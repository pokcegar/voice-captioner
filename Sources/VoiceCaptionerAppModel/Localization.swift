  ...
  public enum Key: Sendable {
    ...
    public enum Key: Sendable {
        ...
        var zh: String {
            ...
            case .markdownSourceFinal: return "当前内容来自机器 final.md；保存会写入 edited.md，不覆盖原文。"
            case .markdownSourceEdited: return "当前内容来自用户 edited.md。"
            case .markdownWaitingForTranscript: return "等待本地转写生成 final.md，或在这里先记录编辑版。"
            case .capture: return "录音"
            case .outputRoot: return "输出目录"
            case .choose: return "选择…"
            case .meetingTitle: return "会议标题"
        ...
        var en: String {
            ...
            case .editedMarkdown: return "Edited Markdown"
            case .markdownEditor: return "Markdown editor"
            case .saveEditedMarkdown: return "Save edited copy"
            case .markdownSourceFinal: return "Loaded from machine final.md; saving writes edited.md without overwriting it."
            case .markdownSourceEdited: return "Loaded from user edited.md."
            case .markdownWaitingForTranscript: return "Waiting for local transcription to create final.md, or draft edited notes here."
            case .capture: return "Capture"
            case .outputRoot: return "Output root"
            case .choose: return "Choose…"
            case .meetingTitle: return "Meeting title"
        ...
        var de: String {
            ...
            case .settingsInspector: return "Einstellungsinspektor"
            ...
            case .editedMarkdown: return "Bearbeitete Markdown-Datei"
            case .markdownEditor: return "Markdown-Editor"
            case .saveEditedMarkdown: return "Bearbeitete Fassung speichern"
            case .markdownSourceFinal: return "Aus maschineller final.md geladen; Speichern schreibt edited.md ohne Überschreiben."
            case .markdownSourceEdited: return "Aus Benutzerdatei edited.md geladen."
            case .markdownWaitingForTranscript: return "Wartet auf lokale Transkription für final.md; Notizen können hier vorbereitet werden."
