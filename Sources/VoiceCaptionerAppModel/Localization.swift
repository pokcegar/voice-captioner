...
public struct AppStrings: Sendable {
  ...
  public enum Key: Sendable {
    ...
    var de: String {
      ...
      case .markdownSourceFinal: return "Quelle: Maschinen-Markdown"
      case .markdownSourceEdited: return "Quelle: bearbeitetes Markdown"
      case .markdownWaitingForTranscript: return "Wartet auf finales Transkript"
      }
    }
  }
}
